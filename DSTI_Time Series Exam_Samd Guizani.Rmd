...
-   Power daily pattern is comparable during 6 of the week days, but the 7th day has a specific pattern (earlier decrease)
...
-   Some autocorrelation values are significant with the 1st period on ACF and PACF - \> try changing the order p and q
